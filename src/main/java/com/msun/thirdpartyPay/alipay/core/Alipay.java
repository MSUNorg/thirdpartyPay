...
import com.msun.thirdpartyPay.alipay.model.enums.PayMethod;
import com.msun.thirdpartyPay.alipay.model.enums.PaymentType;

/**
 * 支付宝支付
 * 
 * @author zxc Apr 13, 2017 6:38:42 PM
 */
public final class Alipay {
    ...
    public String toString() {
        return "Alipay{" + "merchantId='" + merchantId + '\'' + ", secret='" + secret + '\'' + ", inputCharset='" + inputCharset + '\'' + ", paymentType='" + paymentType + '\'' + ", payMethod='" + payMethod + '\''
               + ", expired='" + expired + '\'' + ", appPriKey='" + appPriKey + '\'' + ", appPubKey='" + appPubKey + '\'' + ", qrPriKey='" + qrPriKey + '\'' + ", qrPubKey='" + qrPubKey + '\'' + '}';
    }
}
