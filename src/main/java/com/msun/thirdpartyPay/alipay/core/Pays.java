...
import com.msun.thirdpartyPay.alipay.model.enums.SignType;
import com.msun.thirdpartyPay.alipay.model.pay.AppPayDetail;
import com.msun.thirdpartyPay.alipay.model.pay.PayDetail;
import com.msun.thirdpartyPay.alipay.model.pay.WapPayDetail;
import com.msun.thirdpartyPay.alipay.model.pay.WebPayDetail;
import com.msun.thirdpartyPay.support.security.RSA;

/**
 * Pay Component
 * 
 * @author zxc Apr 13, 2017 6:39:01 PM
 */
public class Pays extends Component {
    ...
    private String buildPayForm(Map<String, String> payParams) {
        ...
        for (Map.Entry<String, String> param : payParams.entrySet()) {
            form.append("<input type=\"hidden\" name=\"").append(param.getKey()).append("\" value=\"").append(param.getValue()).append("\" />");
        }
