...
/**
 * @author zxc Apr 13, 2017 6:38:55 PM
 */
public abstract class Component {
    ...
    Map<String, String> filterSigningParams(Map<String, String> signingParams) {
        ...
        for (Map.Entry<String, String> kv : signingParams.entrySet()) {
            if (Strings.isNullOrEmpty(kv.getValue()) || AlipayField.SIGN.field().equals(kv.getKey()) || AlipayField.SIGN_TYPE.field().equals(kv.getKey())) {
                continue;
            }
