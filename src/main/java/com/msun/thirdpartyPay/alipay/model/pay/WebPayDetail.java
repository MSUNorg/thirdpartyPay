 ...
 * 支付宝PC网页支付明细
 * 
 * @author zxc Apr 13, 2017 6:20:52 PM
 */
public class WebPayDetail extends PayDetail {
    ...
    /**
     * 客服端IP {@link com.msun.thirdpartyPay.alipay.model.enums.AlipayField#EXTER_INVOKE_IP}
     */
    protected String          exterInvokeIp;

    /**
     * 防钓鱼时间戳 {@link com.msun.thirdpartyPay.alipay.model.enums.AlipayField#ANTI_PHISHING_KEY}
     */
    protected String          antiPhishingKey;

    /**
     * 支付宝错误通知跳转 {@link com.msun.thirdpartyPay.alipay.model.enums.AlipayField#ERROR_NOTIFY_URL}
     */
    protected String          errorNotifyUrl;

    /**
     * 公用回传参数 {@link com.msun.thirdpartyPay.alipay.model.enums.AlipayField#EXTRA_COMMON_PARAM}
     */
    ...
    public String toString() {
        return "WebPayDetail{" + "exterInvokeIp='" + exterInvokeIp + '\'' + ", antiPhishingKey='" + antiPhishingKey + '\'' + ", errorNotifyUrl='" + errorNotifyUrl + '\'' + ", extraCommonParam='" + extraCommonParam
               + '\'' + "} " + super.toString();
    }
}
