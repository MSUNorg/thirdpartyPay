...
public class WebPayDetail extends PayDetail {
    ...
    /**
     * 客服端IP {@link me.hao0.alipay.model.enums.AlipayField#EXTER_INVOKE_IP}
     */
    protected String          exterInvokeIp;

    /**
     * 防钓鱼时间戳 {@link me.hao0.alipay.model.enums.AlipayField#ANTI_PHISHING_KEY}
     */
    protected String          antiPhishingKey;

    /**
     * 支付宝错误通知跳转 {@link me.hao0.alipay.model.enums.AlipayField#ERROR_NOTIFY_URL}
     */
    protected String          errorNotifyUrl;

    /**
     * 公用回传参数 {@link me.hao0.alipay.model.enums.AlipayField#EXTRA_COMMON_PARAM}
     */
