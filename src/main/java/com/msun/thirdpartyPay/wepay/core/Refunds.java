...
import static com.msun.thirdpartyPay.support.util.Preconditions.checkPositive;
...
import com.msun.thirdpartyPay.wepay.model.enums.RefundStatus;
import com.msun.thirdpartyPay.wepay.model.enums.WepayField;
import com.msun.thirdpartyPay.wepay.model.refund.RefundApplyRequest;
import com.msun.thirdpartyPay.wepay.model.refund.RefundApplyResponse;
import com.msun.thirdpartyPay.wepay.model.refund.RefundItem;
import com.msun.thirdpartyPay.wepay.model.refund.RefundQueryResponse;
import com.msun.thirdpartyPay.wepay.util.RandomStrs;

/**
 * 退款组件
 * 
 * @author zxc Apr 13, 2017 6:36:47 PM
 */
        ...
        if (couponRefundCountObj != null) {
            ...
            if (couponRefundCount > 0) {
                ...
                for (int couponItemIndex = 0; couponItemIndex < couponRefundCount; couponItemIndex++) {
                    couponItem = Coupon.newCoupon((String) refundData.get(WepayField.COUPON_REFUND_BATCH_ID + "_" + refundItemIndex + "_" + couponItemIndex),
