 ...
 * 普通账单
 * 
 * @author zxc Apr 13, 2017 6:43:44 PM
 */
public class CommonBill extends Bill {
    ...
    public String toString() {
        return "CommonBill{" + "refundId='" + refundId + '\'' + ", outRefundNo='" + outRefundNo + '\'' + ", refundFee=" + refundFee + ", enterRedPkgRefundFee=" + enterRedPkgRefundFee + ", channel=" + channel
