 ...
 * 退款请求对象
 * 
 * @author zxc Apr 13, 2017 6:45:56 PM
 */
public class RefundApplyRequest implements Serializable {
    ...
    public String toString() {
        return "RefundRequest{" + "deviceInfo='" + deviceInfo + '\'' + ", transactionId='" + transactionId + '\'' + ", outTradeNo='" + outTradeNo + '\'' + ", outRefundNo='" + outRefundNo + '\'' + ", totalFee="
               + totalFee + ", refundFee=" + refundFee + ", refundFeeType=" + refundFeeType + ", opUserId='" + opUserId + '\'' + '}';
    }
}
