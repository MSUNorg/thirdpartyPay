 ...
 * 账单字段
 * 
 * @author zxc Apr 13, 2017 6:43:37 PM
 */
public final class BillFields {
     ...
     * 账单公用起始字段
     */
    private static final List<String> START_FIELDS = Arrays.asList(WepayField.TRADE_TIME, WepayField.APP_ID, WepayField.MCH_ID, WepayField.SUB_MCH_ID, WepayField.DEVICE_INFO, WepayField.TRANSACTION_ID,
                                                                   WepayField.OUT_TRADE_NO, WepayField.OPEN_ID, WepayField.TRADE_TYPE, WepayField.TRADE_STATE, WepayField.BANK_TYPE, WepayField.FEE_TYPE,
     ...
     */
    public static final List<String>  COUNT        = Arrays.asList(WepayField.TRADE_TOTAL_COUNT, WepayField.TRADE_TOTAL_FEE, WepayField.REFUND_TOTAL_FEE, WepayField.COUPON_REFUND_TOTAL_FEE,
