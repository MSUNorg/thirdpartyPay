 ...
 * 公众号支付响应对象
 * 
 * @author zxc Apr 13, 2017 6:45:23 PM
 */
public class JsPayResponse implements Serializable {
    ...
    /**
     * 预支付ID串，如: prepare_id=xxx 注意: JS前端调用时的字段名为package，与java关键字冲突
     */
    private String            pkg;
    ...
    public String toString() {
        return "JsPayResponse{" + "appId='" + appId + '\'' + ", timeStamp='" + timeStamp + '\'' + ", nonceStr='" + nonceStr + '\'' + ", pkg='" + pkg + '\'' + ", signType='" + signType + '\'' + ", paySign='" + paySign
               + '\'' + '}';
    }
}
