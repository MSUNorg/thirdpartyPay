package com.msun.thirdpartyPay.wepay.model.refund;
...
import com.msun.thirdpartyPay.wepay.serializer.FeeTypeDeserializer;
import com.msun.thirdpartyPay.wepay.serializer.RefundChannelDeserializer;

/**
 * 退款结果
 * 
 * @author zxc Apr 13, 2017 6:46:06 PM
 */
public class RefundApplyResponse implements Serializable {
    ...
    public String toString() {
        return "RefundResponse{" + "deviceInfo='" + deviceInfo + '\'' + ", nonceStr='" + nonceStr + '\'' + ", transactionId='" + transactionId + '\'' + ", outTradeNo='" + outTradeNo + '\'' + ", outRefundNo='"
               + outRefundNo + '\'' + ", refundId='" + refundId + '\'' + ", channel=" + channel + ", refundFee=" + refundFee + ", totalFee=" + totalFee + ", feeType=" + feeType + ", cashFee=" + cashFee
               + ", cashRefundFee=" + cashRefundFee + ", couponRefundFee=" + couponRefundFee + ", couponRefundCount=" + couponRefundCount + ", couponRefundId=" + couponRefundId + '}';
    }
}
