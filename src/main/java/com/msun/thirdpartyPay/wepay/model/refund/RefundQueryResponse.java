 ...
 * 退款查询对象
 * 
 * @author zxc Apr 13, 2017 6:46:38 PM
 */
public class RefundQueryResponse implements Serializable {
    ...
    public String toString() {
        return "RefundQueryResponse{" + "transactionId='" + transactionId + '\'' + ", outTradeNo='" + outTradeNo + '\'' + ", totalFee=" + totalFee + ", feeType=" + feeType + ", cashFee=" + cashFee + ", items=" + items
               + '}';
    }
}
