package com.msun.thirdpartyPay.support.date;
...
/**
 * @author zxc Apr 13, 2017 6:12:58 PM
 */
public class Dates {
    ...
    public static Boolean isValidDate(String date, String pattern) {
        return !Strings.isNullOrEmpty(date) && Pattern.compile(pattern).matcher(date).matches();
    }
