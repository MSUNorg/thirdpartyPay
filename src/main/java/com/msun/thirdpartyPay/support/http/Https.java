...
import com.msun.thirdpartyPay.support.exception.HttpsException;
import com.msun.thirdpartyPay.support.util.Strings;

/**
 * 简单的Https请求工具
 * 
 * @author zxc Apr 13, 2017 6:15:07 PM
 */
public final class Https {
    ...
    private String doRequest() {
        ...
        try (InputStream in = respCode == HttpURLConnection.HTTP_OK ? connection.getInputStream() : connection.getErrorStream(); BufferedReader reader = new BufferedReader(new InputStreamReader(in))) {
